...
import { DisconnectStripeMutation as DisconnectStripeData } from "../../../../lib/graphql/globalTypes"; 
import { UserQuery as UserData } from "../../../../lib/graphql/globalTypes"
    ...
    const additionalDetails = user.hasWallet ? (
        ...
        <Fragment>
            <Paragraph>
                ...
                <Paragraph type="secondary">
                    TinyHouse uses <a href="https://stripe.com/en-US/connect" target="blank" rel="noopener noreferrer">Stripe</a> to help transfer your earnings in a secure and trusted manner.
                </Paragraph>
        </Fragment>
    );
